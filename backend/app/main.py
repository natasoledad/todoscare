...
from app.routers import admin, agenda, aranceles, aseguradora, auth, cajas, crm, crm_gestion, empresa, farmacia, ia, integraciones, medico, patients, public, salud, tributario, wallet
