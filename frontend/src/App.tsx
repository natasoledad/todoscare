...
const EmpresaCoberturas = lazyNamed(() => import('./routes/empresa/Coberturas'), 'Coberturas');
...
const EmpresaConocimiento = lazyNamed(() => import('./routes/empresa/Conocimiento'), 'Conocimiento');
          ...
          <Routes>
            ...
            <Route element={<RequireAuth />}>
              ...
              <Route element={<RequireRole role="empresa" />}>
                ...
                <Route path="/empresa/copago" element={<EmpresaCoberturas />} />
                ...
                <Route path="/empresa/conocimiento" element={<EmpresaConocimiento />} />
